package com.java.oops.cohesion;

public class CohesionIntroduction
{
	// 1. For every component a clear well-defined functionality is defined then that component is said to be follow
	// high-cohesion.
